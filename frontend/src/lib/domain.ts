...
export type ResearchSnapshotStatus = "verified" | "fallback" | "no_evidence" | "extraction_failed" | "stale" | "unavailable";
...
export interface ResearchBundle {
  ...
  status: "verified" | "fallback" | "no_evidence" | "extraction_failed";
